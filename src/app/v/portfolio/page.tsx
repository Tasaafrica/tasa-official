    ...
    <div className="relative min-h-[500px] pb-12">
      ...
      {!loading && (
        <div className="space-y-12">
          {/* Add Project Section */}
          <div className="bg-white rounded-3xl border border-slate-100 p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Showcase your custom developments, designs, or services
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. https://myproject.com or github.com/username/project"
                    className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-4 focus:ring-slate-100 focus:border-slate-800 transition-all duration-200"
                  />
                </div>
              ...
              {/* Image Upload/Thumbnail Preview (Right side) */}
              <div className="lg:col-span-5">
                ...
                {croppedImage ? (
                  <div className="relative w-40 h-40 rounded-2xl overflow-hidden border border-slate-200 shadow-sm group mx-auto lg:mx-0">
                    {/* biome-ignore lint/performance/noImgElement: Using cropped base64 data URL */}
                    <img
                      src={croppedImage}
                  ...
                  <>
                    <button
                      ...
                      className="w-full h-40 border-2 border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center p-4 text-center cursor-pointer hover:border-slate-400 hover:bg-slate-50/50 transition-all font-normal"
                    >
                ...
                <div className="p-6 bg-slate-50 flex-grow overflow-hidden flex items-center justify-center min-h-[300px]">
                  {imageToCrop && (
                    <div className="max-w-full max-h-[40vh] overflow-hidden rounded-xl border border-slate-200">
                      {/* biome-ignore lint/performance/noImgElement: CropperJS requires native img element ref */}
                      <img
                        ref={imageElementRef}
                        src={imageToCrop}
            ...
            {projects.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {projects.map((project) => (
                  <div
                    key={project._id}
                    className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 group flex flex-col h-full"
                  >
                    {/* Thumbnail Frame */}
                    <div className="aspect-square w-full bg-slate-50 relative overflow-hidden">
                      {/* biome-ignore lint/performance/noImgElement: Using local base64/cropped thumbnail */}
                      <img
                      ...
                      <button
                        ...
                        className="absolute top-3 right-3 p-2 bg-white/90 hover:bg-red-600 text-slate-700 hover:text-white rounded-xl transition-all duration-200 shadow-sm opacity-0 group-hover:opacity-100"
